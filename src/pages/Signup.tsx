...
import { Eye, EyeOff, Gift, User, Mail, Lock, CheckCircle2, XCircle, Loader2 } from 'lucide-react'
...
export default function Signup() {
  ...
  useEffect(() => {
    const validateReferralCode = async () => {
      ...
      try {
        ...
        const { valid, message, referrerName } = response.data;
  ...
  const isFormValid = formData.name && formData.email && formData.password && 
                      ...
                      agreedToTerms && formData.password.length >= 8
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { user, token, message, warning } = response.data;
      ...
      <Card className="w-full max-w-md p-8 bg-card border-border">
        ...
        <div className="mb-6">
          ...
          <p className="text-muted-foreground text-sm">
            Join REGs Global for Shariah-compliant trading
          </p>
        </div>

        {/* Referral Bonus Banner */}
        {formData.referralCode && (
          <div className="bg-gradient-to-r from-emerald-500/10 to-green-500/10 border-2 border-emerald-500/30 rounded-xl p-4 mb-6 animate-fade-in">
            <div className="flex items-center gap-3">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            {formData.confirmPassword && formData.password !== formData.confirmPassword && (
              <p className="text-destructive text-sm mt-2">Passwords do not match</p>
            )}
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className={`w-full h-12 pl-10 pr-10 bg-input text-foreground placeholder:text-muted-foreground uppercase transition-colors ${
                  formData.referralCode && referralValidation.isValid === true
                    ? 'border-emerald-500 focus:border-emerald-500'
                    : formData.referralCode && referralValidation.isValid === false
            ...
            {formData.referralCode && referralValidation.isValid === true && (
              <p className="text-xs text-emerald-600 dark:text-emerald-400 mt-2 flex items-center">
                ...
                {referralValidation.message} - Get bonus rewards!
              </p>
            )}
            {formData.referralCode && referralValidation.isValid === false && !referralValidation.isValidating && (
              <p className="text-xs text-amber-600 dark:text-amber-400 mt-2 flex items-center">
                <XCircle className="h-3 w-3 mr-1" />
                {referralValidation.message} - You can still sign up
              </p>
            )}
          </div>
          ...
          <div className="flex items-start space-x-3 mb-6">
            ...
            >
              By creating an account, I agree to REGs Global's{' '}
